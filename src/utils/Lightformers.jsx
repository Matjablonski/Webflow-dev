...
const Lightformers = React.forwardRef(({ positions = [2, 0, 2, 0, 2, 0, 2, 0] }, ref) => {

    const group = useRef()

    useFrame((state, delta) => (group.current.position.z += delta * 10) > 60 && (group.current.position.z = -60))
