...
export default function BmwM4(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF("https://dl.dropbox.com/scl/fi/b326joslmrikj0x34lz6l/bmw-m4.glb?rlkey=k7mou31uesndxyncid42nj95j");
  ...
  useLayoutEffect(() => {
    ...
    applyProps(materials.Material_692, { envMapIntensity: 2, clearCoat: 1, clearCoatRoughness: 0.5, roughness: 0.45, metalness: 0.8, color: '#adadad' })
