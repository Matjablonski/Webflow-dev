...
export default function Model(props) {
  ...
  useLayoutEffect(() => {
    ...
    applyProps(materials.Specular_Railing, { metalness: 0.8, clearcoat: 1, roughness: 0.12, roughnessMap: null, normalScale: [4, 4], toneMapped: false, specularIntensity: 0.5 })
    ...
    applyProps(materials.Kuzov_Main_color, { envMapIntensity: 3, clearcoat: 1, reflectivity: 1, roughness: 0.12, metalness: 0.15, color: '#adadad' })
