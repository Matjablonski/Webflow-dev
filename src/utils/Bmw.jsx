...
export default function Bmw(props) {
  ...
  useLayoutEffect(() => {
    ...
    applyProps(materials.vm_T3_024_brake_disc, { envMapIntensity: 4, reflectivity: 1, roughness: 0.1, metalness: 0.8, color: '#121212' })
    // applyProps(materials.Mirrors_color, { envMapIntensity: 4, roughness: 0.5, metalness: 1 })
    applyProps(materials.vm_T3_001_carpaint, { envMapIntensity: 2, clearCoat: 1, roughness: 0.4, metalness: 0.9, color: '#adadad' })
